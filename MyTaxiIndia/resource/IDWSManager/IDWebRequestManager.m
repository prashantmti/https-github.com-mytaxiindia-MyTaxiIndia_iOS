...
-(void)makeRequestSes:(IDWebRequestManager *)requestData
{
...
-(NSURL *)createRequestUrl:(IDWebRequestManager *)requestData
{
    ...
    NSURL * url = [NSURL URLWithString:[urlStr stringByReplacingPercentEscapesUsingEncoding:NSASCIIStringEncoding]];
    return url;
}
